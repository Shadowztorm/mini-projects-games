...
# transformed it in exe file using pyinstaller. To keep the console on screen this is a small trick
# otherwise console will close immediately as winner is displayed or game ends
a=input()